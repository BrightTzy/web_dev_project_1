...
export default function Dashboard() {
  ...
  const categoryData = categories
    ...
    .concat(
      tasks.some((task) => !task.category)
        ? [
            {
              name: "Uncategorized",
              count: tasks.filter((task) => !task.category).length,
              fill: "#94a3b8",
            },
          ]
        : [],
  ...
  let early = 0,
    ...
    late = 0;
  tasks
    .filter((t) => t.status === "DONE" && t.dueDate && t.completeDate)
    .forEach((t) => {
      const due = t.dueDate;
      const completed = t.completeDate;
    ...
    <div style={{ paddingBottom: "2rem" }}>
      ...
      <div className="charts-grid">
        ...
        <div className="chart-panel">
          ...
          <div style={{ height: "300px" }}>
            {performanceData.some((d) => d.count > 0) ? (
              ...
              >
                Complete a task with a due date to see performance metrics.
              </p>
            )}
          </div>
        </div>
        ...
        <div className="chart-panel">
          ...
          <div style={{ height: "300px" }}>
            {categoryData.some((category) => category.count > 0) ? (
              <ResponsiveContainer width="100%" height="100%">
              ...
              >
                Create a categorized task to see category metrics.
              </p>
            )}
          </div>
        </div>
